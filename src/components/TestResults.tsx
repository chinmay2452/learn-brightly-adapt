...
const TestResults: React.FC<TestResultsProps> = ({ score }) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg animate-pop">
      <h1 className="text-2xl font-bold mb-6 text-center">Your Test Results</h1>
      
      <div className="flex flex-col items-center mb-8">
        <motion.div 
          className={`w-48 h-48 ${resultColor} rounded-full flex items-center justify-center text-4xl font-bold mb-4`}
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
